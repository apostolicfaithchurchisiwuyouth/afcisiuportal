...
(function () {
    ...
    function renderHeaderAvatar(user) {
         ...
         * #headerAvatarLetter
         *
         * We support both so the homepage
         * remains compatible.
         */
    ...
    async function loadCurrentLessonPreview() {
        ...
        container.innerHTML = `
            <div class="home-lesson-loading">
                ...
                <div class="home-lesson-loading-content">
                    ...
                    <div class="home-loading-line home-loading-line-title"></div>

                    <div class="home-loading-line home-loading-line-text"></div>

                    <div class="home-loading-line home-loading-line-short"></div>
        ...
        try {
            ...
            /*
             * Make sure our central API layer
             * is available.
             */
            ...
            /*
             * Ask the backend for the lessons.
             */
            ...
            container.innerHTML = `
                <div class="home-lesson-preview">
                    ...
                    <div class="home-lesson-preview-content">
                        ...
                        <span class="home-lesson-preview-label">
                            ${week}
                        </span>
                        ...
                        <button
                            type="button"
                            class="home-lesson-preview-button"
             ...
             * IMPORTANT:
             *
             * We deliberately send the user to
             * pages/lessons.html.
             *
             * We do NOT attempt to open the lesson
             * directly from index.html.
             *
             * lessons.js owns the lesson reader.
             */
            ...
            container.innerHTML = `
                <div class="empty-state">
                    ...
                    <div class="empty-state-icon">
                        <span data-lucide="wifi-off"></span>
                    </div>
    ...
    async function performLogout() {
        ...
        /*
         * Allow the loading state to paint.
         */
            ...
            function (eventName) {
                ...
                window.addEventListener(
                    ...
                    function () {
                         ...
                         * refresh the lesson preview too.
                         */
